...
//este codigo es el mismo del archivo AR.cpp, solo que este es el utilizado para pasar la prueba del mooshak, mientras que el otro
//es el que hemos usado para realizar nuestras mediciones ya que es mas comodo
